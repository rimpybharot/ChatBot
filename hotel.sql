...
CREATE TABLE IF NOT EXISTS `hotel_reservation`.`reservation` (
  ...
  `rDateFrom` DATETIME NULL,
  `rDateTo` DATETIME NULL,
  `rRoomCount` INT NULL,
  `rReservationStatus` VARCHAR(45) NULL,
  `hotels_hotelID` INT NOT NULL,
  PRIMARY KEY (`reservationID`),
  INDEX `fk_reservation_hotels1_idx` (`hotels_hotelID` ASC),
  CONSTRAINT `fk_reservation_hotels1`
